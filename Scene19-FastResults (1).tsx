...
export const Scene19FastResultsAlt: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <span>{"< 5 "}</span>
        <span style={{ color: "#C4B5FD" }}>min</span>
      </div>
